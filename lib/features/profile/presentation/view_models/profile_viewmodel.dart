...
// import 'package:flutter_application_1/features/auth/presentation/view_model/auth_viewmodel.dart'; // ← added
...
//           uploadPhotoName: imageUrl,
//         );

//         // Optimistic update → show new photo in CircleAvatar immediately
//         final currentAuthState = ref.read(authViewModelProvider);

//         if (currentAuthState.authEntity != null) {
//           final updatedUser = currentAuthState.authEntity!.copyWith(
