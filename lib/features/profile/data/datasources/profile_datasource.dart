...
abstract interface class IProfileLocalDataSource {
  ...
  /// Update existing cached profile
  Future<void> updateCachedProfile(ProfileHiveModel profile);

  /// Clear profile for a user (e.g. on logout)
  Future<void> clearProfile(String studentId);

  /// Optional: Clear all cached profiles
